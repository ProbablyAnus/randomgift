...
const DEFAULT_THEME = {
  light: {
    ...
    divider: "#EFEFF3",
    overlay: "#EFEFF3",
    closeButtonBg: "#E3E3E8",
    closeButtonFg: "#9E9EA1",
    switchBg: "#EFEFF3",
    toastBg: "#2D2D2DCC",
    searchFieldBg: "#E4E4E4",
  },
  dark: {
    bg: "#1C1C1E",
    secondary: "#2C2C2E",
    ...
    divider: "#000000",
    overlay: "#1C1C1E",
    closeButtonBg: "#2C2C2E",
    closeButtonFg: "#8E8E93",
    switchBg: "#000000",
    toastBg: "#000000CC",
    searchFieldBg: "#00000080",
  },
};
...
export function SettingsProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    const apply = () => {
      ...
      const headerColor = toRgba(headerBg, 0.75);
      ...
      root.style.setProperty("--headerColor", headerColor);
      root.style.setProperty("--backgroundColor", bgColor);
      root.style.setProperty("--textColor", textColor);
      root.style.setProperty("--dividerColor", defaults.divider);
      root.style.setProperty("--overlayColor", defaults.overlay);
      root.style.setProperty("--closeButtonBg", defaults.closeButtonBg);
      root.style.setProperty("--closeButtonFg", defaults.closeButtonFg);
      root.style.setProperty("--switchBg", defaults.switchBg);
      root.style.setProperty("--toastBg", defaults.toastBg);
      root.style.setProperty("--searchFieldBg", defaults.searchFieldBg);

      root.style.setProperty("--app-bg", bgColor);
      root.style.setProperty("--app-card", secondaryBg);
      root.style.setProperty("--tabbar-bg", headerColor);
